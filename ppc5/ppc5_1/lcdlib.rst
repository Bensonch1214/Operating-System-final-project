      ...
      00036F 85 3E 82         [24]  307 	mov	dpl, _lcd_ready
                                    308 ;	lcdlib.c:18: }
      000372 22               [24]  309 	ret
                                    310 ;------------------------------------------------------------
                                    ...
                                    316 ;	-----------------------------------------
      000373                        317 _LCD_Init:
                                    318 ;	lcdlib.c:20: LCD_functionSet();
      000373 12 03 A8         [24]  319 	lcall	_LCD_functionSet
                                    320 ;	lcdlib.c:21: LCD_entryModeSet(1, 1); /* increment and no shift */
      000376 75 82 07         [24]  321 	mov	dpl, #0x07
      000379 12 03 86         [24]  322 	lcall	_LCD_IRWrite
                                    323 ;	lcdlib.c:22: LCD_displayOnOffControl(1, 1, 1); /* display on, cursor on and blinking on */
      00037C 75 82 0F         [24]  324 	mov	dpl, #0x0f
      00037F 12 03 86         [24]  325 	lcall	_LCD_IRWrite
                                    326 ;	lcdlib.c:23: lcd_ready = 1;
      000382 75 3E 01         [24]  327 	mov	_lcd_ready,#0x01
                                    328 ;	lcdlib.c:24: }
      000385 22               [24]  329 	ret
                                    330 ;------------------------------------------------------------
                                    ...
                                    338 ;	-----------------------------------------
      000386                        339 _LCD_IRWrite:
      000386 AF 82            [24]  340 	mov	r7, dpl
                                    341 ;	lcdlib.c:26: lcd_ready = 0;
      000388 75 3E 00         [24]  342 	mov	_lcd_ready,#0x00
                                    343 ;	lcdlib.c:27: DB = (c & 0xf0); // high nibble, keep RS low
      00038B 74 F0            [12]  344 	mov	a,#0xf0
      00038D 5F               [12]  345 	anl	a,r7
      00038E F5 90            [12]  346 	mov	_P1,a
                                    347 ;	lcdlib.c:28: E = 1;  // pulse E
                                    348 ;	assignBit
      000390 D2 92            [12]  349 	setb	_P1_2
                                    350 ;	lcdlib.c:29: E = 0;
                                    351 ;	assignBit
      000392 C2 92            [12]  352 	clr	_P1_2
                                    353 ;	lcdlib.c:30: DB = (c << 4); // low nibble, keep RS low
      000394 EF               [12]  354 	mov	a,r7
      000395 C4               [12]  355 	swap	a
      000396 54 F0            [12]  356 	anl	a,#0xf0
      000398 F5 90            [12]  357 	mov	_P1,a
                                    358 ;	lcdlib.c:31: E = 1;
                                    359 ;	assignBit
      00039A D2 92            [12]  360 	setb	_P1_2
                                    361 ;	lcdlib.c:32: E = 0;
                                    362 ;	assignBit
      00039C C2 92            [12]  363 	clr	_P1_2
                                    364 ;	lcdlib.c:33: delay(DELAY_AMOUNT);
      00039E 75 82 28         [24]  365 	mov	dpl, #0x28
      0003A1 12 04 31         [24]  366 	lcall	_delay
                                    367 ;	lcdlib.c:34: lcd_ready = 1;
      0003A4 75 3E 01         [24]  368 	mov	_lcd_ready,#0x01
                                    369 ;	lcdlib.c:35: }
      0003A7 22               [24]  370 	ret
                                    371 ;------------------------------------------------------------
                                    ...
                                    377 ;	-----------------------------------------
      0003A8                        378 _LCD_functionSet:
                                    379 ;	lcdlib.c:37: lcd_ready = 0;
      0003A8 75 3E 00         [24]  380 	mov	_lcd_ready,#0x00
                                    381 ;	lcdlib.c:40: DB = 0x20;  // DB<7:4> = 0010, <RS,E,x,x>=0
      0003AB 75 90 20         [24]  382 	mov	_P1,#0x20
                                    383 ;	lcdlib.c:41: E = 1;
                                    384 ;	assignBit
      0003AE D2 92            [12]  385 	setb	_P1_2
                                    386 ;	lcdlib.c:42: E = 0;
                                    387 ;	assignBit
      0003B0 C2 92            [12]  388 	clr	_P1_2
                                    389 ;	lcdlib.c:43: delay(DELAY_AMOUNT);
      0003B2 75 82 28         [24]  390 	mov	dpl, #0x28
      0003B5 12 04 31         [24]  391 	lcall	_delay
                                    392 ;	lcdlib.c:44: E = 1;
                                    393 ;	assignBit
      0003B8 D2 92            [12]  394 	setb	_P1_2
                                    395 ;	lcdlib.c:45: E = 0;
                                    396 ;	assignBit
      0003BA C2 92            [12]  397 	clr	_P1_2
                                    398 ;	lcdlib.c:46: delay(DELAY_AMOUNT); // added, to ensure sufficient delay
      0003BC 75 82 28         [24]  399 	mov	dpl, #0x28
      0003BF 12 04 31         [24]  400 	lcall	_delay
                                    401 ;	lcdlib.c:47: DB7 = 1; // 2-line model
                                    402 ;	assignBit
      0003C2 D2 97            [12]  403 	setb	_P1_7
                                    404 ;	lcdlib.c:49: E = 1;
                                    405 ;	assignBit
      0003C4 D2 92            [12]  406 	setb	_P1_2
                                    407 ;	lcdlib.c:50: E = 0;
                                    408 ;	assignBit
      0003C6 C2 92            [12]  409 	clr	_P1_2
                                    410 ;	lcdlib.c:51: delay(DELAY_AMOUNT);
      0003C8 75 82 28         [24]  411 	mov	dpl, #0x28
      0003CB 12 04 31         [24]  412 	lcall	_delay
                                    413 ;	lcdlib.c:52: lcd_ready = 1;
      0003CE 75 3E 01         [24]  414 	mov	_lcd_ready,#0x01
                                    415 ;	lcdlib.c:53: }
      0003D1 22               [24]  416 	ret
                                    417 ;------------------------------------------------------------
                                    ...
                                    425 ;	-----------------------------------------
      0003D2                        426 _LCD_write_char:
      0003D2 AF 82            [24]  427 	mov	r7, dpl
                                    428 ;	lcdlib.c:56: lcd_ready = 0;
      0003D4 75 3E 00         [24]  429 	mov	_lcd_ready,#0x00
                                    430 ;	lcdlib.c:57: DB = (c & 0xf0) | 0x08; //; keep the RS
      0003D7 74 F0            [12]  431 	mov	a,#0xf0
      0003D9 5F               [12]  432 	anl	a,r7
      0003DA 44 08            [12]  433 	orl	a,#0x08
      0003DC F5 90            [12]  434 	mov	_P1,a
                                    435 ;	lcdlib.c:58: RS = 1;
                                    436 ;	assignBit
      0003DE D2 93            [12]  437 	setb	_P1_3
                                    438 ;	lcdlib.c:59: E = 1;
                                    439 ;	assignBit
      0003E0 D2 92            [12]  440 	setb	_P1_2
                                    441 ;	lcdlib.c:60: E = 0;
                                    442 ;	assignBit
      0003E2 C2 92            [12]  443 	clr	_P1_2
                                    444 ;	lcdlib.c:61: DB = (c << 4) | 0x08; // keep the RS
      0003E4 EF               [12]  445 	mov	a,r7
      0003E5 C4               [12]  446 	swap	a
      0003E6 54 F0            [12]  447 	anl	a,#0xf0
      0003E8 FF               [12]  448 	mov	r7,a
      0003E9 74 08            [12]  449 	mov	a,#0x08
      0003EB 4F               [12]  450 	orl	a,r7
      0003EC F5 90            [12]  451 	mov	_P1,a
                                    452 ;	lcdlib.c:62: E = 1;
                                    453 ;	assignBit
      0003EE D2 92            [12]  454 	setb	_P1_2
                                    455 ;	lcdlib.c:63: E = 0;
                                    456 ;	assignBit
      0003F0 C2 92            [12]  457 	clr	_P1_2
                                    458 ;	lcdlib.c:64: delay(DELAY_AMOUNT);
      0003F2 75 82 28         [24]  459 	mov	dpl, #0x28
      0003F5 12 04 31         [24]  460 	lcall	_delay
                                    461 ;	lcdlib.c:65: lcd_ready = 1;
      0003F8 75 3E 01         [24]  462 	mov	_lcd_ready,#0x01
                                    463 ;	lcdlib.c:66: }
      0003FB 22               [24]  464 	ret
                                    465 ;------------------------------------------------------------
                                    ...
                                    473 ;	-----------------------------------------
      0003FC                        474 _LCD_write_string:
      0003FC AD 82            [24]  475 	mov	r5, dpl
      0003FE AE 83            [24]  476 	mov	r6, dph
      000400 AF F0            [24]  477 	mov	r7, b
                                    478 ;	lcdlib.c:68: while (*str++) {
      000402                        479 00101$:
      000402 8D 82            [24]  480 	mov	dpl,r5
      000404 8E 83            [24]  481 	mov	dph,r6
      000406 8F F0            [24]  482 	mov	b,r7
      000408 12 05 62         [24]  483 	lcall	__gptrget
      00040B FC               [12]  484 	mov	r4,a
      00040C A3               [24]  485 	inc	dptr
      00040D AD 82            [24]  486 	mov	r5,dpl
      00040F AE 83            [24]  487 	mov	r6,dph
      000411 EC               [12]  488 	mov	a,r4
      000412 60 1C            [24]  489 	jz	00104$
                                    490 ;	lcdlib.c:69: LCD_write_char(*str);
      000414 8D 82            [24]  491 	mov	dpl,r5
      000416 8E 83            [24]  492 	mov	dph,r6
      000418 8F F0            [24]  493 	mov	b,r7
      00041A 12 05 62         [24]  494 	lcall	__gptrget
      00041D F5 82            [12]  495 	mov	dpl,a
      00041F C0 07            [24]  496 	push	ar7
      000421 C0 06            [24]  497 	push	ar6
      000423 C0 05            [24]  498 	push	ar5
      000425 12 03 D2         [24]  499 	lcall	_LCD_write_char
      000428 D0 05            [24]  500 	pop	ar5
      00042A D0 06            [24]  501 	pop	ar6
      00042C D0 07            [24]  502 	pop	ar7
      00042E 80 D2            [24]  503 	sjmp	00101$
      000430                        504 00104$:
                                    505 ;	lcdlib.c:71: }
      000430 22               [24]  506 	ret
                                    507 ;------------------------------------------------------------
      ...
      000431                        518 dhere:
      000431 D5 82 FD         [24]  519 	djnz	dpl, dhere
                                    520 ;	lcdlib.c:78: }
      000434 22               [24]  521 	ret
                                    522 	.area CSEG    (CODE)
                                    523 	.area CONST   (CODE)
                                    524 	.area XINIT   (CODE)
