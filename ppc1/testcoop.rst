      ...
      000000 02 00 A8         [24]  291 	ljmp	__sdcc_gsinit_startup
      ...
      000049 02 00 9C         [24]  371 	ljmp	_main
                                    ...
                                    379 ;------------------------------------------------------------
                                    380 ;	testcoop.c:18: void Producer(void)
                                    381 ;	-----------------------------------------
      ...
      00004F                        384 _Producer:
                           ...
                           000001   391 	ar1 = 0x01
                           000000   392 	ar0 = 0x00
                                    393 ;	testcoop.c:20: currentChar = 'A';
      00004F 75 3B 41         [24]  394 	mov	_currentChar,#0x41
                                    395 ;	testcoop.c:23: while (bufferFull){
      000052                        396 00101$:
      000052 E5 3C            [12]  397 	mov	a,_bufferFull
      000054 60 05            [24]  398 	jz	00103$
                                    399 ;	testcoop.c:24: ThreadYield();
      000056 12 01 51         [24]  400 	lcall	_ThreadYield
      000059 80 F7            [24]  401 	sjmp	00101$
      00005B                        402 00103$:
                                    403 ;	testcoop.c:26: buffer = currentChar;
      00005B 85 3B 3A         [24]  404 	mov	_buffer,_currentChar
                                    405 ;	testcoop.c:27: bufferFull = 1;
      00005E 75 3C 01         [24]  406 	mov	_bufferFull,#0x01
                                    407 ;	testcoop.c:28: currentChar = (currentChar == 'Z') ? 'A' : currentChar + 1;
      000061 74 5A            [12]  408 	mov	a,#0x5a
      000063 B5 3B 04         [24]  409 	cjne	a,_currentChar,00109$
      000066 7E 41            [12]  410 	mov	r6,#0x41
      000068 80 08            [24]  411 	sjmp	00110$
      00006A                        412 00109$:
      00006A AD 3B            [24]  413 	mov	r5,_currentChar
      00006C 0D               [12]  414 	inc	r5
      00006D ED               [12]  415 	mov	a,r5
      00006E FE               [12]  416 	mov	r6,a
      00006F 33               [12]  417 	rlc	a
      000070 95 E0            [12]  418 	subb	a,acc
      000072                        419 00110$:
      000072 8E 3B            [24]  420 	mov	_currentChar,r6
                                    421 ;	testcoop.c:30: }
      000074 80 DC            [24]  422 	sjmp	00101$
                                    423 ;------------------------------------------------------------
                                    424 ;Allocation info for local variables in function 'Consumer'
                                    425 ;------------------------------------------------------------
                                    426 ;	testcoop.c:34: void Consumer(void)
                                    427 ;	-----------------------------------------
                                    428 ;	 function Consumer
                                    429 ;	-----------------------------------------
      000076                        430 _Consumer:
                                    431 ;	testcoop.c:36: TMOD = 0x20;
      000076 75 89 20         [24]  432 	mov	_TMOD,#0x20
                                    433 ;	testcoop.c:37: TH1 = -6;
      000079 75 8D FA         [24]  434 	mov	_TH1,#0xfa
                                    435 ;	testcoop.c:38: SCON = 0x50;
      00007C 75 98 50         [24]  436 	mov	_SCON,#0x50
                                    437 ;	testcoop.c:39: TR1 = 1;
                                    438 ;	assignBit
      00007F D2 8E            [12]  439 	setb	_TR1
                                    440 ;	testcoop.c:41: while (!bufferFull){
      000081                        441 00101$:
      000081 E5 3C            [12]  442 	mov	a,_bufferFull
      000083 70 05            [24]  443 	jnz	00103$
                                    444 ;	testcoop.c:42: ThreadYield();
      000085 12 01 51         [24]  445 	lcall	_ThreadYield
      000088 80 F7            [24]  446 	sjmp	00101$
      00008A                        447 00103$:
                                    448 ;	testcoop.c:44: SBUF = buffer;
      00008A 85 3A 99         [24]  449 	mov	_SBUF,_buffer
                                    450 ;	testcoop.c:45: bufferFull = 0;
      00008D 75 3C 00         [24]  451 	mov	_bufferFull,#0x00
                                    452 ;	testcoop.c:46: while (!TI){
      000090                        453 00104$:
      000090 20 99 05         [24]  454 	jb	_TI,00106$
                                    455 ;	testcoop.c:47: ThreadYield();
      000093 12 01 51         [24]  456 	lcall	_ThreadYield
      000096 80 F8            [24]  457 	sjmp	00104$
      000098                        458 00106$:
                                    459 ;	testcoop.c:49: TI = 0;
                                    460 ;	assignBit
      000098 C2 99            [12]  461 	clr	_TI
                                    462 ;	testcoop.c:52: }
      00009A 80 E5            [24]  463 	sjmp	00101$
                                    464 ;------------------------------------------------------------
                                    465 ;Allocation info for local variables in function 'main'
                                    466 ;------------------------------------------------------------
                                    467 ;	testcoop.c:56: void main(void)
                                    468 ;	-----------------------------------------
                                    469 ;	 function main
                                    470 ;	-----------------------------------------
      00009C                        471 _main:
                                    472 ;	testcoop.c:58: bufferFull = 0;
      00009C 75 3C 00         [24]  473 	mov	_bufferFull,#0x00
                                    474 ;	testcoop.c:59: ThreadCreate(Producer);
      00009F 90 00 4F         [24]  475 	mov	dptr,#_Producer
      0000A2 12 00 CD         [24]  476 	lcall	_ThreadCreate
                                    477 ;	testcoop.c:60: Consumer();
                                    478 ;	testcoop.c:61: }
      0000A5 02 00 76         [24]  479 	ljmp	_Consumer
                                    480 ;------------------------------------------------------------
                                    481 ;Allocation info for local variables in function '_sdcc_gsinit_startup'
                                    482 ;------------------------------------------------------------
                                    483 ;	testcoop.c:63: void _sdcc_gsinit_startup(void)
                                    484 ;	-----------------------------------------
                                    485 ;	 function _sdcc_gsinit_startup
                                    486 ;	-----------------------------------------
      0000A8                        487 __sdcc_gsinit_startup:
                                    488 ;	testcoop.c:67: __endasm;
      0000A8 02 00 AF         [24]  489 	LJMP	_Bootstrap
                                    490 ;	testcoop.c:68: }
      0000AB 22               [24]  491 	ret
                                    492 ;------------------------------------------------------------
                                    493 ;Allocation info for local variables in function '_mcs51_genRAMCLEAR'
                                    494 ;------------------------------------------------------------
                                    495 ;	testcoop.c:70: void _mcs51_genRAMCLEAR(void) {}
                                    496 ;	-----------------------------------------
                                    497 ;	 function _mcs51_genRAMCLEAR
                                    498 ;	-----------------------------------------
      0000AC                        499 __mcs51_genRAMCLEAR:
      0000AC 22               [24]  500 	ret
                                    501 ;------------------------------------------------------------
                                    502 ;Allocation info for local variables in function '_mcs51_genXINIT'
                                    503 ;------------------------------------------------------------
                                    504 ;	testcoop.c:71: void _mcs51_genXINIT(void) {}
                                    505 ;	-----------------------------------------
                                    506 ;	 function _mcs51_genXINIT
                                    507 ;	-----------------------------------------
      0000AD                        508 __mcs51_genXINIT:
      0000AD 22               [24]  509 	ret
                                    510 ;------------------------------------------------------------
                                    511 ;Allocation info for local variables in function '_mcs51_genXRAMCLEAR'
                                    512 ;------------------------------------------------------------
                                    513 ;	testcoop.c:72: void _mcs51_genXRAMCLEAR(void) {}
                                    514 ;	-----------------------------------------
                                    515 ;	 function _mcs51_genXRAMCLEAR
                                    516 ;	-----------------------------------------
      0000AE                        517 __mcs51_genXRAMCLEAR:
      0000AE 22               [24]  518 	ret
                                    519 	.area CSEG    (CODE)
                                    520 	.area CONST   (CODE)
                                    521 	.area XINIT   (CODE)
